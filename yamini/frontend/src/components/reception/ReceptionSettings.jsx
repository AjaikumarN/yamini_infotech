...
export default function ReceptionSettings({ onClose }) {
  ...
  // Password state (removed - no password change functionality)
  ...
  const fetchSettings = async () => {
    try {
      ...
      const saved = localStorage.getItem('reception_notifications');
      if (saved) {
  ...
  const handleNotificationChange = (key) => {
    ...
    localStorage.setItem('reception_notifications', JSON.stringify(updated));
          ...
          {activeTab === 'notifications' && (
            <div style={{ display: 'grid', gap: '16px' }}>
              <p style={{ fontSize: '14px', color: '#64748b', marginBottom: '8px' }}>
                Control alerts relevant to your reception work
              </p>

              {[
                { key: 'new_enquiry', label: '📧 New Enquiry Notifications', desc: 'Get notified when new customer enquiries arrive' },
                { key: 'new_complaint', label: '🚨 New Complaint Alerts', desc: 'Get notified when service complaints are filed' },
                { key: 'repeat_complaint', label: '⚠️ Repeat Complaint Alert', desc: 'Get notified when same customer has multiple complaints' },
          ...
          {activeTab === 'help' && (
            <div style={{ display: 'grid', gap: '16px' }}>
              <div style={{
                ...
                <h4 style={{ margin: '0 0 12px 0', fontSize: '14px', fontWeight: '600', color: '#1e40af' }}>
                  📖 How to Use Reception Dashboard
                </h4>
                <ul style={{ margin: 0, paddingLeft: '20px', fontSize: '13px', color: '#1e3a8a', lineHeight: '1.6' }}>
                  <li><strong>Dashboard Overview:</strong> Track today's enquiries, complaints, and service requests</li>
                  <li><strong>Enquiries:</strong> Log new customer inquiries by priority (HOT, WARM, COLD)</li>
                  <li><strong>Service Requests:</strong> Create and manage service tickets, assign to engineers</li>
                  <li><strong>Calls Log:</strong> Record all incoming and outgoing calls</li>
                  <li><strong>Visitors:</strong> Log visitor check-in and check-out times</li>
                  <li><strong>Reports:</strong> View daily, weekly, and monthly activity reports</li>
                </ul>
              </div>
              ...
              <div style={{
                ...
                <div style={{ fontSize: '13px', color: '#78350f', lineHeight: '1.8' }}>
                  <p style={{ marginBottom: '12px' }}>
                    <strong>Q: Can I edit a service request after creating it?</strong><br />
                    A: Yes, you can edit open service requests. Click the service request to open details and update information.
                  </p>
                  <p style={{ marginBottom: '12px' }}>
                    <strong>Q: How do I assign a service request to an engineer?</strong><br />
                    A: Click the "Select Engineer" dropdown on a NEW service request to assign it to an available engineer.
                  </p>
                  <p>
                    <strong>Q: What's the difference between HOT, WARM, and COLD enquiries?</strong><br />
                    A: HOT = High priority/interested, WARM = Medium priority/considering, COLD = Low priority/initial contact.
                  </p>
                </div>
              </div>
              ...
              <div style={{
                ...
                <h4 style={{ margin: '0 0 12px 0', fontSize: '14px', fontWeight: '600', color: '#991b1b' }}>
                  📞 Contact Support
                </h4>
                <div style={{ fontSize: '13px', color: '#7f1d1d', lineHeight: '1.8' }}>
                  <p style={{ margin: '0 0 8px 0' }}>
                    <strong>IT Support:</strong> it@yamini.com<br />
                    <strong>Phone:</strong> +91-XXXX-XXXX-XX
                  </p>
                  <p style={{ margin: 0 }}>
                    For technical issues or feature requests, please contact the IT department.
                  </p>
                </div>
              </div>
              ...
              <div style={{
                ...
                <p style={{ margin: 0, fontSize: '13px', color: '#6b7280' }}>
                  v1.0.0 (Reception Dashboard) | Last Updated: January 2026
                </p>
              </div>
            </div>
          )}
