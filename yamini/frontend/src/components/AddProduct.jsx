...
const AddProduct = () => {
 ...
 <h2 style={styles.sectionTitle}>1⃣ Basic Product Details</h2>
 ...
 <div style={styles.section}>
 <h2 style={styles.sectionTitle}>2⃣ Product Photo</h2>
 ...
 {/* Product Specifications */}
 <div style={styles.section}>
 <h2 style={styles.sectionTitle}>3⃣ Product Specifications</h2>
 ...
 {/* Usage & Target */}
 <div style={styles.section}>
 <h2 style={styles.sectionTitle}>4⃣ Usage & Target</h2>
 ...
 <div style={styles.section}>
 <h2 style={styles.sectionTitle}>5⃣ Pricing & Availability</h2>
 ...
 {/* Warranty & Service */}
 <div style={styles.section}>
 <h2 style={styles.sectionTitle}>6⃣ Warranty & Service</h2>
 ...
 <div style={styles.section}>
 <h2 style={styles.sectionTitle}>8⃣ Internal Data (Confidential)</h2>
 ...
 {/* Publish Control */}
 <div style={styles.section}>
 <h2 style={styles.sectionTitle}>9⃣ Publish Control</h2>
